...
const Navbar = () => {
  ...
  // Dynamically read user from localStorage
      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex space-x-8">
            ...
            <NavLink to="/resume-analysis" isActive={isActive('/resume-analysis')}>Resume Analysis</NavLink>
            <NavLink to="/interview-questions" isActive={isActive('/interview-questions')}>Interview Questions</NavLink>
          ...
          <div className="md:hidden flex">
            <div className="flex space-x-2">
              ...
              <MobileNavLink to="/resume-analysis" isActive={isActive('/resume-analysis')}>Resume</MobileNavLink>
              <MobileNavLink to="/interview-questions" isActive={isActive('/interview-questions')}>Questions</MobileNavLink>
          ...
          <div className="flex items-center">
            <Link to="/profile">
              {/* Use ui-avatars image or fallback text avatar */}
              <img
                src={avatarUrl}
                alt={user.name}
