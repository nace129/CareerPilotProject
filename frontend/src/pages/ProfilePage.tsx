...
const ProfilePage = () => {
  ...
  const user = storedUser
    ...
    : {
        ...
        avatarUrl: "https://ui-avatars.com/api/?name=Guest&background=6366f1&color=fff"
      };

  const avatarUrl = `https://ui-avatars.com/api/?name=${encodeURIComponent(user.name)}&background=6366f1&color=fff`;

  // You can later fetch real stats — for now, keep mock stats
  const stats = {
    interviewsTaken: 12,
    lastMatchScore: 78,
    questionsAnswered: 84,
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
            <Card>
              ...
              <CardContent>
                <div className="text-3xl font-bold">{stats.interviewsTaken}</div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-3xl font-bold">{stats.lastMatchScore}%</div>
                <Progress value={stats.lastMatchScore} className="h-2 mt-2" />
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-3xl font-bold">{stats.questionsAnswered}</div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-3xl font-bold">{stats.uploadCount}</div>
              </CardContent>
            </Card>
          </div>
